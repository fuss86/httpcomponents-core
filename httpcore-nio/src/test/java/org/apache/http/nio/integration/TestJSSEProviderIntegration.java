...
//                {"BouncyCastle"}
    ...
    public TestJSSEProviderIntegration(final String securityProviderName) {
        super();
    ...
    public TestRule resourceRules = RuleChain.outerRule(new ExternalResource() {
        ...
        protected void before() throws Throwable {
            ...
            server.setConnectionFactory(new ServerConnectionFactory(sslContext, null));
        ...
        protected void before() throws Throwable {
            ...
            client = new HttpClientNio(new BasicNIOConnFactory(sslContext, null, ConnectionConfig.DEFAULT));
