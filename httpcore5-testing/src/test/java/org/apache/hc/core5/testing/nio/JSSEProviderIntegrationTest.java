...
//                {"BouncyCastle"}
    ...
    public JSSEProviderIntegrationTest(final String securityProviderName) {
        super();
    ...
    public TestRule resourceRules = RuleChain.outerRule(new ExternalResource() {
        ...
        protected void before() throws Throwable {
            ...
            } else if ("BouncyCastle".equalsIgnoreCase(securityProviderName)) {
                securityProvider = new BouncyCastleJsseProvider();
            } else {
        ...
        protected void before() throws Throwable {
            ...
            final URL keyStoreURL = SSLTestContexts.class.getResource("/test-server.p12");
            ...
            server = new Http1TestServer(IOReactorConfig.DEFAULT, sslContext);
        }
        ...
        protected void before() throws Throwable {
            ...
            final URL keyStoreURL = SSLTestContexts.class.getResource("/test-client.p12");
            final String storePassword = "nopassword";
            final SSLContext sslContext = SSLContextBuilder.create()
                    .setProvider(securityProvider)
                    .setKeyStoreType("pkcs12")
            ...
            client = new Http1TestClient(IOReactorConfig.DEFAULT, sslContext);
        }
